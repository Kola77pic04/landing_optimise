    ...
    return (
        <form className="space-y-4 lg:space-y-6" onSubmit={handleSubmit}>
            ...
            <button
                ...
                className={`w-full py-3.5 bg-gradient-to-r from-slate-600 to-black/80 text-white font-medium rounded-lg shadow-lg 
                           hover:bg-[#24B7C3]/90 hover:shadow-xl hover:-translate-y-1
                           transition-all duration-300 flex items-center justify-center gap-2 group ${loading ? "cursor-not-allowed opacity-80" : "cursor-pointer"} ${sendDatas ? "!bg-[#7ABB5C] hover:!bg-green-700/80" : ""}`}
            >
